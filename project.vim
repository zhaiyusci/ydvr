...
vnoremap \f :py3file /usr/share/clang/clang-format-6.0/clang-format.py
nnoremap \f :py3file /usr/share/clang/clang-format-6.0/clang-format.py
nnoremap <silent> \m :call Mousetoggle() 
nnoremap <silent> \<F5> :set hlsearch! 
...
nnoremap <silent> <F7> :set spell! 
nnoremap <silent> <F6> :set wrap! 
nnoremap <silent> <F5> :NERDTree 
nnoremap <silent> <F4> :set rnu! 
...
argglobal
2argu
if bufexists("molecule.h") | buffer molecule.h | else | edit molecule.h | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 29 - ((11 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
